...
with st.expander("🙀 **[집 주인에게 집을 빌리는 상황]** - 이 상황은 '넷플릭스 구독'이나 '도서관 책 대여'와 비슷해요!"):
    st.markdown("""
    🙀 **[집 주인에게 집을 빌리는 상황]**  
...
with st.expander("❓ 용어가 어려울때는 이것을 먼저 봐주세요! (자세한 용어 사전 보기)"):
    st.markdown("""
    ### 🏢 1. 내 소득은 어느 정도일까?
    ...
    * **📉 이자 지원:** 은행에서 돈을 빌리면 빌린 값(이자)을 내야 하는데, 군산시가 그 '빌린 값'을 대신 내주는 거예요!. ​서울시의 경우 청년 임차보증금 이자 지원 사업을 통해 이자 부담을 덜어주고 있어요.
    * **🏢 임대주택 보증금:** 나라(LH 등)가 운영하는 저렴한 빌린 집에 들어갈 때 맡기는 돈이에요. 일반 집보다 훨씬 싸요!
    * **⚠️ 월세 조건:** "보증금 5천만 원 이하, 월세 70만 원 이하인 집만 도와줄게!"와 같이 정부가 정한 규칙이에요. ​예를 들어, 서울시 청년 임차보증금 이자 지원은 보증금 3억 원 이하, 월세 70만 원 이하의 주택에 적용되다가 2025년부터 월세 90만 원으로 기준이 완화됩니다
